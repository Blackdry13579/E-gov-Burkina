  ...
  return (
    <div className="font-sans max-w-6xl mx-auto pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Gestion des Services</h1>
          <p className="text-sm text-gray-400 font-medium mt-1">Entités rattachées au portail national</p>
        </div>
        <button 
